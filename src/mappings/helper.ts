...
export const TRIBAL_CHIEF_START_BLOCK = BigInt.fromI32(13135382)

// export const UNISWAP_SUSHI_ETH_PAIR_FIRST_LIQUDITY_BLOCK = BigInt.fromI32(10750005)
export const UNISWAP_FEI_TRIBE_PAIR_FIRST_LIQUDITY_BLOCK = BigInt.fromI32(12125707)
...
export const TRIBAL_CHIEF_ADDRESS = Address.fromString(
...
// )
export const UNISWAP_FEI_TRIBE_PAIR_ADDRESS = Address.fromString(
  '0x9928e4046d7c6513326ccea028cd3e7a91c7590a'
)

export const FEI_ADDRESS = Address.fromString(
  '0x956f47f50a910163d8bf957cf5846d573e7f87ca'
)

export const TRIBE_ADDRESS = Address.fromString(
